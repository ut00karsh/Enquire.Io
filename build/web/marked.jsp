...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    ...
    %>
    <div>  <a class="btn btn-outline-info" href="unanswered.jsp" style="left:15%; position: absolute;" >UnAnswered Queries</a>     <a href="query.jsp" style="left:65%; position: absolute;" class="btn btn-outline-info">Ask Question</a> <br><br><br></div>
   <%
        String user_id1= (String)session.getAttribute("u_id");
        String marked = "select query_id from marked where user_id ='"+user_id1+"'";
