...
<br>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item" style="margin-left:50%;">
        <a class="nav-link active" data-toggle="tab" href="answer.jsp" style="font-family: cursive;font-size: 120%;" >Home</a>
    </li>
    <li class="nav-item">
...
function funDisplay(name) {
        ...
        {%>
          ...
          <button class="btn btn-outline-success btn-sm" onclick="funDisplay('com+<%=rs.getInt("answer_id")%>')">add a comment</button>
           ...
           <div style="padding: 24px ;display: none; " id="com+<%=rs.getInt("answer_id")%>"> 
               ...
               <textarea
                   class="form-control" rows="15" name="comment" id="froala-editor"  placeholder="put your Answer here" required >
               </textarea>
               <br>
  ...
  <form method ="post" action="answer_register" enctype="multipart/form-data" name="Form1" >
      <br><br>
    <span class="badge badge-secondary" style='margin-left: 12%;'> <h4 style="font-family:cursive ;color: white"> Post An Answer</h4></span>
      <div style="padding:24px">
          <textarea   name="answer1" rows="8" cols="1" id="demo0" placeholder="put your Answer here"  required>
