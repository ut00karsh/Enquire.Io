...
<script>
   ...
   <script>
        ...
        <a id= "demo" href="unanswered.jsp" style="left:55%;" id="demo">UnAnswered Queries</a>   <br>
        <hr>
        <br>
        <div class="container">
...
<div style="align:center;"> <a href="answer.jsp?query_id=<%=z%>&role=<%="admin"%>&u_id=<%=S6%>" style=" text-decoration: none; position:absolute ;font-size:14px; left:34% ;" class="btn btn-outline-success" > Answer It</a> </div>
