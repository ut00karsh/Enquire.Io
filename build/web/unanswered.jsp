...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    ...
    %>
    <div>      <a href="query.jsp" style="left:65%; position: absolute;" class='btn btn-outline-info'>Ask Question</a> <br><br><br></div>
   <%
...
<a  href="#" class="btn btn-outline-success btn-sm" style=" left:18%; position:absolute;"><%=a_count%><br>Answers</a> 
 ...
 <br><div style="align:center;"> <a href="answer.jsp?query_id=<%=z%>&role=<%="user"%>&u_id=<%=S6%>" style=" text-decoration: none; position:absolute ;font-size:14px; left:34% ;" class='btn btn-outline-success' > Answer It</a> </div>
