...
<script>
   ...
   function question(name)
   {
       ...
       xttp.onreadystatechange = function(){
           ...
           xttp.open("GET","users_query.jsp?query_id="+name,true);
...
<div class="container">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu1" style="font-family: cursive; font-size: 120%;" onclick="question('<%=nid%>')">Answers</a>
    </li>
    <li class="nav-item">
  ...
  <div class="tab-content">
   ...
   <%
        ...
        s="select query_string from query_details where user_id='"+nid+"'";
        t="select q_description from query_details where user_id='"+nid+"'";
