 ...
 <li class="nav-item">
   ...
   <li class="nav-item">
    ...
    &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="login.jsp">Tags</a>
                </li>
                  <%
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    ...
    %>
    <div>  <a  href="unanswered.jsp" style="left:15%; position: absolute;" class="btn btn-outline-info" >UnAnswered Queries</a>     <a href="query.jsp" style="left:65%; position: absolute;" class="btn btn-outline-info">Ask Question</a> <br><br><br></div>
   <%
        String user_id1= (String)session.getAttribute("u_id");
        String marked = "select query_id from frequent where user_id ='"+user_id1+"'order by count desc";
        ResultSet marked1 = jdbc.selectData(marked);
       
        while (marked1.next())
        {
        
        s="select query_string from query_details where query_id="+ marked1.getInt("query_id");
        t="select q_description from query_details where query_id="+ marked1.getInt("query_id");
...
<h3><a id="anchor" href="answer.jsp?query_id=<%=z%>&role=<%="user"%>&u_id=<%=S6%>" style=" text-decoration: none; left:25%; font-size: 80%;"><font color="CornflowerBlue "><%=  rs2.getString(1)  %></font></a></h3><br><br>
