      ...
      <%
        ...
        %>
             ...
             &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="/login">Tags</a>
                </li>
                  <%
...
<a  href="#" class="btn btn-outline-success btn-sm" style=" left:18%; position:absolute;"><%=a_count%><br>Answers</a>   
        ...
        <h3 ><a id="anchor" href="answer.jsp?query_id=<%=z%>&role=<%="user"%>&u_id=<%=S6%>" style=" text-decoration: none; left:25%;font-size: 83%; "><font color="CornflowerBlue"><%=  rs2.getString(1)  %>
                </font></a></h3><br><br>
